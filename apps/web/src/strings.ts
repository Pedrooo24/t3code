...
export const strings = {
  ...
  subagents: {
    ...
    stalled: "stalled",
    herdadoDaThread: "herdado da thread",
    verDetalhes: "Ver detalhes",
  },

  agentInspector: {
    titulo: "Inspector de agente",
    fechar: "Fechar",
    conversa: "Conversa",
    resumo: "Resumo",
    promptRecebido: "Prompt recebido do orquestrador",
    respostaEntregue: "Resposta entregue ao orquestrador",
    semResposta: "Sem resposta registada",
    semPrompt: "Sem prompt registado",
    mcps: "MCPs",
    skills: "Skills",
    tools: "Tools",
    tokens: "tokens",
    ...
    ficheiros: "Ficheiros tocados",
    comandos: "Comandos bash",
    semActividade: "Sem actividade registada",
    servidores: "por servidor",
  },
